...
<html lang="en" dir=>
  ...
  <body>
    ...
    <div style="position:relative;top:60px;left:800x;height:500px;" class="container centre-div shadow"  >
      <div class="heading text-center mb-5 text-uppercase text-white">
       CREATE ITEM

      </div>
    <div style="position:relative;top:50px;max-width:690px" class="container-fluid  p-4  " >
      <div style="position:relative;height:360px;" class="card">
            <form action="populateTableUser.php" method="post" enctype="multipart/form-data">
