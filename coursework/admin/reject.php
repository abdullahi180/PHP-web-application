  ...
  <div style="position:relative;top:60px;left:800x;height:500px;" class="container centre-div"  >
    ...
    while ($rows=mysqli_fetch_assoc($result))
    {
     ...
     <div style="position:relative;top:50px;max-width:700px" class="container-fluid  p-4  " max-width:1250px>
       ...
       <form action="emailRejected.php" method="post">
         ...
         <div class="form-horizontal">
           <div class="col-md-8">
           <label>Status</label>
           <input type="text" name="status" value= "Denied">
         </div>
         </div>
         <div class="form-horizontal">
           <div class="col-md-8">
           <label>Description</label>
           <textarea class="form-control" name="reason" cols="50" rows="3">We have decided to reject your request because we believe..</textarea></br>
         </div>
